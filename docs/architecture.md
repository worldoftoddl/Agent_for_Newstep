...
> 2026-07-17 현행화 — 4그래프 체제·단일 Space 배포 반영.
...
- `config["configurable"]["model"]` 접두사 라우팅: `anthropic:`(기본
  ...
  `hf:`(Inference Providers 라우터) / `local:`(Ollama). 4개 그래프가 공유.
